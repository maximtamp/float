...
`,m={iTime:{value:0},iResolution:{value:new o.Vector2(window.innerWidth,window.innerHeight)},uBoatPosition:{value:new o.Vector3(0,0,0)},waterBaseColor:{value:new o.Color("#093e74")},waterColor:{value:new o.Color("#63773c")},waterTopColor:{value:new o.Color("#135d23")}},$=()=>{const e=new o.PlaneGeometry(1e3,1e3,500,500);e.rotateX(Math.PI/2);const n=new o.RawShaderMaterial({uniforms:m,vertexShader:J,fragmentShader:Z,side:o.DoubleSide,glslVersion:o.GLSL3}),t=new o.Mesh(e,n);return t.receiveShadow=!0,t.castShadow=!0,{mesh:t}},O=(e=0,n)=>{const t=new o.Object3D,d=new o.CylinderGeometry(10,10,40,50,2,!1,Math.PI*.5,Math.PI*1),r=new o.MeshPhongMaterial({color:"#1f1f1f",flatShading:!0}),s=new o.Mesh(d,r);s.rotateX(-Math.PI/2),s.castShadow=!0,s.receiveShadow=!0,t.add(s);const C=new o.BoxGeometry(20,2,40,1,1,1),z=new o.MeshPhongMaterial({color:"#dedede",flatShading:!0}),q=new o.Mesh(C,z);q.position.y=1,q.castShadow=!0,q.receiveShadow=!0,t.add(q);const V=new o.BoxGeometry(15,15,8,1,1,1),Q=new o.MeshPhongMaterial({color:"#dedede",flatShading:!0}),E=new o.Mesh(V,Q);E.position.y=2,E.position.z=15,E.castShadow=!0,E.receiveShadow=!0,t.add(E);for(let p=0;p<e;p++){const X=new o.BoxGeometry(8,3,3,1,1,1),Y=new o.MeshPhongMaterial({color:n[p],flatShading:!0}),g=new o.Mesh(X,Y);p<6||p>11&&p<18?(g.position.x=-5,p>11&&p<18?g.position.z=-15+4*(p-12):g.position.z=-15+4*p):(g.position.x=5,p>17?g.position.z=-15+4*(p-18):g.position.z=-39+4*p),p<12?g.position.y=4:g.position.y=7,g.castShadow=!0,g.receiveShadow=!0,t.add(g)}return{mesh:t}},ee=(e="#d2760e")=>{const n=new o.BoxGeometry(24,8,8);n.rotateX(Math.PI/2);const t=new o.MeshPhongMaterial({color:e,flatShading:!0}),d=new o.Mesh(n,t);return d.receiveShadow=!0,d.castShadow=!0,{mesh:d}},oe=()=>{const e=new o.BoxGeometry(2,12,20);e.rotateX(Math.PI/2);const n=new o.MeshPhongMaterial({color:"#f2ee02",flatShading:!0}),t=new o.Mesh(e,n);return t.receiveShadow=!0,{mesh:t}},te=()=>{const e=new o.Object3D,n=[{x:500,z:0,width:16,length:1016},{x:0,z:500,width:1016,length:16},{x:0,z:-500,width:1016,length:16},{x:-500,z:0,width:16,length:1016}];for(let t=0;t<4;t++){const d=new o.BoxGeometry(n[t].width,n[t].length,16);d.rotateX(Math.PI/2);const r=new o.MeshPhongMaterial({color:"#1a5a99",flatShading:!0}),s=new o.Mesh(d,r);s.position.x=n[t].x,s.position.z=n[t].z,s.castShadow=!0,e.add(s)}return{mesh:e}},ne=document.querySelector("#c"),P=new o.WebGLRenderer({canvas:ne,alpha:!0,antialias:!0});P.shadowMap.enabled=!0;const ae=90,re=window.innerWidth/window.innerHeight,ie=1,se=1e4,y=new o.PerspectiveCamera(ae,re,ie,se);y.position.set(0,90,0);y.lookAt(0,0,0);const f=new o.Scene;let k,a,w,A,B;const R=new o.Box3,I=new o.Box3,H=new o.Box3,U=new o.Box3;let h=0,u=0,S=0,c=0,T={startTime:0,endTime:0},M="menu",x={active:!1,TimeUntilActive:10};const i={default:[{waterBaseColor:"#093e74",waterColor:"#63773c",waterTopColor:"#135d23"},{waterBaseColor:"#1a5a99",waterColor:"#789d50",waterTopColor:"#2b7e36"},{waterBaseColor:"#2b7fbf",waterColor:"#90b66a",waterTopColor:"#3da84a"},{waterBaseColor:"#4ca3e0",waterColor:"#add486",waterTopColor:"#5bcc63"}],red:{waterBaseColor:"#740909",waterColor:"#ad2c2c",waterTopColor:"#6d2222"}},L=[],v=12,D=["#3751cf","#d2760e","#a31010","#afafaf","#dbdada"],_=[],F=new K(y,P.domElement);F.target.set(0,0,0);F.update();let l={ArrowUp:!1,ArrowDown:!1,ArrowRight:!1,ArrowLeft:!1};const N=()=>{for(let e=0;e<v;e++){const n=D[Math.floor(Math.random()*D.length)];A=ee(n).mesh,A.position.set((Math.random()-.5)*450,0,(Math.random()-.5)*450),A.rotation.z=Math.random()*.5,A.rotation.y=Math.random()*100,f.add(A),L.push({mesh:A,color:n})}},le=()=>{fe(),k=$().mesh,k.receiveShadow=!0,f.add(k),a=O(c).mesh,a.receiveShadow=!0,f.add(a),N(),B=te().mesh,B.receiveShadow=!0,f.add(B);const e=new o.DirectionalLight(16777215,1.5);e.position.set(50,100,50),e.castShadow=!0,f.add(e);const n=new o.AmbientLight(16777215,.4);f.add(n),e.shadow.camera.top=2e3,e.shadow.camera.bottom=-2e3,e.shadow.camera.left=-2e3,e.shadow.camera.right=2e3,e.shadow.camera.near=1,e.shadow.camera.far=2e3,e.shadow.mapSize.width=5e3,e.shadow.mapSize.height=5e3,W(),f.background=new o.Color("#255174"),requestAnimationFrame(G)},ce=new o.Clock,G=()=>{h=ce.getElapsedTime(),m.iTime.value=h,l.ArrowUp&&u<=.35&&(u+=.002),l.ArrowDown&&u>=-.35&&(u-=.001),u!=0&&l.ArrowLeft&&(a.rotation.y+=.005,S<=.1&&(S+=.005)),u!=0&&l.ArrowRight&&(a.rotation.y-=.005,S>=-.1&&(S-=.005)),a.rotation.z=S,a.rotation.x=Math.sin(h)*.15,a.position.y=3.5+Math.sin(h*2)*.5;const e=new o.Vector3(0,0,-1);e.applyQuaternion(a.quaternion),a.position.add(e.clone().multiplyScalar(u)),u>0?u-=5e-4:u<0&&(u+=5e-4),S>0?S-=.0025:S<0&&(S+=.0025);const n=new o.Vector3(0,40,60);if(n.applyQuaternion(a.quaternion),y.position.copy(a.position.clone().add(n)),y.lookAt(a.position),R.setFromObject(a),L.forEach((t,d)=>{if(H.setFromObject(t.mesh),t.mesh.rotation.x=Math.sin(h)*.15,t.mesh.position.y=3.5+Math.sin(h*2)*.5,R.intersectsBox(H)){f.remove(t.mesh),L.splice(d,1);const r={xPos:a.position.x,yPos:a.position.y,zPos:a.position.z,xRot:a.rotation.x,yRot:a.rotation.y,zRot:a.rotation.z};f.remove(a),c++,_.push(t.color),a=O(c,_).mesh,a.position.set(r.xPos,r.yPos,r.zPos),a.rotation.set(r.xRot,r.yRot,r.zRot),f.add(a),c===v?b("gameWon"):(m.waterBaseColor.value.set(i.default[Math.floor(c/v*i.default.length)].waterBaseColor),m.waterColor.value.set(i.default[Math.floor(c/v*i.default.length)].waterColor),m.waterTopColor.value.set(i.default[Math.floor(c/v*i.default.length)].waterTopColor))}}),m.uBoatPosition.value.set(a.position.x,a.position.y,a.position.z),M==="game"){if(document.querySelector("#timer").innerHTML=Math.round((h-T.startTime)*100)/100,!x.active&&Math.floor(h*1e3)>x.TimeUntilActive)x.active=!0,w=oe().mesh,w.receiveShadow=!0,w.position.set(a.position.x+((Math.random()-.5)*150+100),3.5,a.position.z+((Math.random()-.5)*150+100)),f.add(w),document.querySelector("#sharkAlert").classList.remove("visually-hidden");else if(x.active){const t=new o.Vector3(0,0,-1);t.applyQuaternion(w.quaternion),w.lookAt(a.position),w.position.add(t.clone().multiplyScalar(-.5)),w.rotation.z=Math.sin(h)*.25,y.position.x=a.position.x,y.position.y=150,y.position.z=a.position.z,y.lookAt(a.position),m.waterBaseColor.value.set(i.red.waterBaseColor),m.waterColor.value.set(i.red.waterColor),m.waterTopColor.value.set(i.red.waterTopColor),I.setFromObject(w),R.intersectsBox(I)&&(document.querySelector("#sharkAlert").classList.add("visually-hidden"),b("gameOver"),f.remove(w),x.active=!1)}}B.children.forEach(t=>{U.setFromObject(t),R.intersectsBox(U)&&(u=-u*.5,console.log("appel"))}),P.render(f,y),requestAnimationFrame(G)},W=()=>{const e=P.domElement,n=e.clientWidth*window.devicePixelRatio|0,t=e.clientHeight*window.devicePixelRatio|0;(e.width!==n||e.height!==t)&&(P.setSize(n,t,!1),y.aspect=n/t,y.updateProjectionMatrix())},de=e=>{M==="game"?(e.key==="ArrowUp"&&(l.ArrowUp=!0),e.key==="ArrowDown"&&(l.ArrowDown=!0),e.key==="ArrowLeft"&&(l.ArrowLeft=!0),e.key==="ArrowRight"&&(l.ArrowRight=!0),e.key==="z"&&x.active===!0&&(f.remove(w),x.active=!1,x.TimeUntilActive=h*1e3+(Math.random()*6e3+6e3),m.waterBaseColor.value.set(i.default[Math.floor(c/v*i.default.length)].waterBaseColor),m.waterColor.value.set(i.default[Math.floor(c/v*i.default.length)].waterColor),m.waterTopColor.value.set(i.default[Math.floor(c/v*i.default.length)].waterTopColor),document.querySelector("#sharkAlert").classList.add("visually-hidden"))):e.key==="Enter"&&b("game")},me=e=>{M==="game"&&(e.key==="ArrowUp"&&(l.ArrowUp=!1),e.key==="ArrowDown"&&(l.ArrowDown=!1),e.key==="ArrowLeft"&&(l.ArrowLeft=!1),e.key==="ArrowRight"&&(l.ArrowRight=!1))},b=e=>{if(M=e,M==="menu")document.querySelector("#menu").classList.remove("visually-hidden");else if(M==="game")document.querySelector("#gameUi").classList.remove("visually-hidden"),document.querySelector("#menu").classList.add("visually-hidden"),document.querySelector("#gameOverMenu").classList.add("visually-hidden"),document.querySelector("#gameWonMenu").classList.add("visually-hidden"),x.TimeUntilActive=h*1e3+(Math.random()*6e3+6e3),c=0,L.forEach(n=>{f.remove(n.mesh)}),L.length=0,_.length=0,m.waterBaseColor.value.set(i.default[Math.floor(c/v*i.default.length)].waterBaseColor),m.waterColor.value.set(i.default[Math.floor(c/v*i.default.length)].waterColor),m.waterTopColor.value.set(i.default[Math.floor(c/v*i.default.length)].waterTopColor),N(),f.remove(a),a=O(c,_).mesh,a.position.set(0,0,0),a.rotation.set(0,0,0),f.add(a),T.startTime=h;else if(M==="gameOver")document.querySelector("#gameUi").classList.add("visually-hidden"),document.querySelector("#gameOverMenu").classList.remove("visually-hidden"),document.querySelector("#totalScore").innerHTML="Score: "+c,l.ArrowUp=!1,l.ArrowDown=!1,l.ArrowLeft=!1,l.ArrowRight=!1,u=0,S=0,T.endTime=h,console.log(T.endTime-T.startTime);else if(M==="gameWon"){const n=Math.round((h-T.startTime)*100)/100+" Sec";document.querySelector("#gameUi").classList.add("visually-hidden"),document.querySelector("#gameWonMenu").classList.remove("visually-hidden"),document.querySelector("#totalTime").innerHTML="Current Time: "+n;const t=parseFloat(localStorage.getItem("bestTime"));isNaN(t)||parseFloat(n)<t?(localStorage.setItem("bestTime",n),document.querySelector("#bestTime").innerHTML="Best Time: "+n):document.querySelector("#bestTime").innerHTML="Best Time: "+t,l.ArrowUp=!1,l.ArrowDown=!1,l.ArrowLeft=!1,l.ArrowRight=!1,u=0,S=0,T.endTime=h}},j=()=>{b("game")},fe=async()=>{const e=await navigator.mediaDevices.getUserMedia({audio:!0,video:!1}),n=new AudioContext,t=n.createMediaStreamSource(e),d=n.createAnalyser();t.connect(d);const r=new Float32Array(d.fftSize),s=()=>{d.getFloatTimeDomainData(r);let C=0;for(const z of r)C+=z*z;C>250&&M==="game"&&(f.remove(w),x.active=!1,x.TimeUntilActive=h*1e3+(Math.random()*6e3+6e3),m.waterBaseColor.value.set(i.default[Math.floor(c/v*i.default.length)].waterBaseColor),m.waterColor.value.set(i.default[Math.floor(c/v*i.default.length)].waterColor),m.waterTopColor.value.set(i.default[Math.floor(c/v*i.default.length)].waterTopColor),document.querySelector("#sharkAlert").classList.add("visually-hidden")),window.requestAnimationFrame(s)};window.requestAnimationFrame(s)};window.addEventListener("resize",W);window.addEventListener("keydown",de);window.addEventListener("keyup",me);document.querySelector("#startButton").addEventListener("click",j);document.querySelector("#playAgainButton").addEventListener("click",j);le();
